...
".active{ border:2px solid #ABF9E7;}"))
        ...
        self.countLabel = QtGui.QPushButton(self.widgets)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.countLabel.setFont(font)
        self.countLabel.setText(_fromUtf8(""))
        ...
        self.currentLayout.setSpacing(3)
        ...
        self.currentLayout.addWidget(self.label_3, 0, 0, 1, 2)
        self.currentLabel = QtGui.QLabel(self.widgets)
        ...
        self.currentLayout.addWidget(self.currentLabel, 1, 0, 1, 2)
        ...
        QtCore.QObject.connect(self.countLabel, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.clearCount)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "CSpark Research : Multi Channel Analyzer", None))
        ...
        self.countLabel.setToolTip(_translate("MainWindow", "Total Input Pulses. Click to clear the counter", None))
...
"Also allows single point calibration if the actual value of the peak is known", None))
        ...
        self.label_3.setText(_translate("MainWindow", "Constant Current Source", None))
        self.currentLabel.setToolTip(_translate("MainWindow", "Constant Current Source output voltage.\n"
"Colour changes to green for valid loads", None))
        self.currentLabel.setText(_translate("MainWindow", "Source Preparation:", None))
