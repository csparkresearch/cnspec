...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.imageView, 1, 1, 1, 1)
        self.gradientBox = QtWidgets.QComboBox(self.centralwidget)
        self.gradientBox.setObjectName("gradientBox")
        self.gridLayout_2.addWidget(self.gradientBox, 0, 1, 1, 1)
        ...
        self.gradientBox.currentIndexChanged['QString'].connect(MainWindow.changeGradient)
